...
--
-- Using ROWNUM (oracle's way of implementing the LIMIT clause in SQL)
-- Top-N reporting.
...
-- Download the file company.doc; it is provided for your convenience in order to check the results of your queries.
--
(B)
...
-- Name: Kevin Kredit
--
/*(110) Using ROWNUM to limit the size of the result. (Notice that SQL and some systems use the
 * LIMIT or TOP clauses. Oracle uses ROWNUM to accomplish similar tasks.)
