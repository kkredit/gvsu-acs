...
public interface PresenceService {
    ...
    /**
     * Register the URI of the server.
     ...
     */
    boolean register(RegistrationInfo reg);
     ...
     *
     */
    boolean updateRegistrationInfo(RegistrationInfo reg);
     ...
     */
    RegistrationInfo lookup(String name);
     ...
     */
    Vector<RegistrationInfo> listRegisteredUsers();
}
