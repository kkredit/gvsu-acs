...
public class ChatClient {
    ...
    public static void main(String[] args) {
        ...
        try {
            ...
            Registry registry = LocateRegistry.getRegistry(serverHost, getPort(args));
            ...
            if (!server.register(myInfo)) {
                ...
                messager = new NetworkMessager(myInfo.getPort(), serverHost);
